...
class EC2Driver(driver.ComputeDriver):
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        """
        reservation = self.conn.run_instances('ami-54cf5c3d',key_name='sirus',instance_type='t1.micro',security_groups=['1PI09IS098'],user_data=instance['uuid'])
        publicInstance = reservation.instances[0]        
        while(publicInstance.update()=='pending'):
            continue
        instance['vm_state']='running'
        instance['']
    ...
    def get_host_stats(self, refresh=False):
        dic = {'vcpus': 10,
               ...
               'hypervisor_type': 'EC2',
               'hypervisor_version': '0.1',
               'hypervisor_hostname': 'folsom-controller',
               'cpu_info': 'LOL'}
